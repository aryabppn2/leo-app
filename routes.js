...
const admin_db_conn=url.readFileSync(process.env.admin_db)
const admin=JSON.parse(admin_db_conn)


module.exports={users,qoutes,share_datas,coments,chats,chats_list,admin,url}
