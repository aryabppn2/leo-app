...
const study_db_conn=url.readFileSync(process.env.study_db)
const study=JSON.parse(study_db_conn)
module.exports={users,qoutes,coments,chats,chats_list,study,url}
